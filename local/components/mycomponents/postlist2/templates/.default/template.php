    ...
    <ul class="toggle-menu ">
        <li class="toggle-menu__item">
            <a href="<?= $APPLICATION->GetCurPageParam("THRESHOLD=INF", ["THRESHOLD"], false); ?>" class="toggle-menu__item-link
             ...
             " rel="nofollow" title="<?= GetMessage("THRESHOLD_LESS_TITLE") ?>">
        ...
        <li class="toggle-menu__item">
            <a href="<?= $APPLICATION->GetCurPageParam("THRESHOLD=10", ["THRESHOLD"], false); ?>"
               ...
               rel="nofollow" title="<?= GetMessage("THRESHOLD_10_TITLE") ?>">
        ...
        <li class="toggle-menu__item">
            <a href="<?= $APPLICATION->GetCurPageParam("THRESHOLD=25", ["THRESHOLD"], false); ?>"
               ...
               rel="nofollow" title="<?= GetMessage("THRESHOLD_25_TITLE") ?>">
        ...
        <li class="toggle-menu__item">
            <a href="<?= $APPLICATION->GetCurPageParam("THRESHOLD=50", ["THRESHOLD"], false); ?>"
               ...
               rel="nofollow" title="<?= GetMessage("THRESHOLD_50_TITLE") ?>">
        ...
        <li class="toggle-menu__item">
            <a href="<?= $APPLICATION->GetCurPageParam("THRESHOLD=100", ["THRESHOLD"], false); ?>"
               ...
               rel="nofollow" title="<?= GetMessage("THRESHOLD_100_TITLE") ?>">
            ...
            <li class="content-list__item content-list__item_post shortcuts_item">
                <article class="post post_preview">
                    <header class="post__meta">
                        <a class="post__user-info user-info" title="<?= GetMessage("POST_AUTOR") ?>">
                            <img src="<?= $arItem["PROPERTIES"]["AUTOR"]["PERSONAL_PHOTO"] ?>" width="24" height="24"
                                 class="user-info__image-pic user-info__image-pic_small">
                            <span
                                class="user-info__nickname user-info__nickname_small"><?= $arItem["PROPERTIES"]["AUTOR"]['LOGIN'] ?></span>
                        </a>
                    ...
                    <h2 class="post__title">
                        <a href="<?= $arItem["DETAIL_PAGE_URL"] ?>"
                           class="post__title_link"><? echo $arItem["NAME"] ?></a>
                    </h2>
                    ...
                    <div class="post__body post__body_crop ">
                            ...
                            <? if (is_array($arItem["PREVIEW_PICTURE"])): ?>
                                <a href="<?= $arItem["DETAIL_PAGE_URL"] ?>">
                                    <div style="text-align:center;"><img
                                            src="<? echo $arItem['PREVIEW_PICTURE']['SRC'] ?>" width="600"></div>
                                </a><br>
                            <? endif; ?>
                        ...
                        <a class="btn btn_x-large btn_outline_blue post__habracut-btn"
                           href="<?= $arItem['DETAIL_PAGE_URL'] ?>"><?= GetMessage("DETAIL_POST_READ") ?></a>
                    </div>
                            ...
                            <li class="post-stats__item post-stats__item_voting-wjt">
                                <div class="voting-wjt voting-wjt_post js-post-vote">
                                    <button type="button" class="btn voting-wjt__button ">
                                        <a class="btn voting-wjt__button"
                                           href="<?= $APPLICATION->GetCurPageParam("VOTE=PLUS&ITEM_ID=" . $arItem["ID"], ["VOTE", "ITEM_ID"], false); ?>"
                                           title="<?= GetMessage("VOTE_BUTTON_PLUS_TITLE"); ?>">
                                            <svg class="icon-svg_arrow-up" width="10" height="16">
                                                <path
                                                    d="M6.802.129l-6.709 7.637c-.211.241-.037.615.289.615h3.629c.21 0 .38.167.38.372v14.875c0 .205.169.372.379.372h4.64c.21 0 .379-.167.379-.372v-14.876c0-.205.17-.372.38-.372h3.63c.325 0 .5-.373.289-.615l-6.709-7.637c-.153-.171-.427-.171-.578.001z"
                                                </path>
                                            </svg>
                                        </a>
                                    </button>
                                    ...
                                    <span
                                        class="voting-wjt__counter_<? echo ($arItem['PROPERTIES']['VOTE_RESULT']['VALUE'] < 0) ? 'negative' : 'positive'; ?>  voting-wjt__counter_js-score"
                                        title="<?= GetMessage('COMMON_RATING', ['#VOTE_RESULT#' => $arItem['PROPERTIES']['VOTE_RESULT']['VALUE'], '#PLUSES_COUNT#' => $arItem['PROPERTIES']['PLUSES_COUNT']['VALUE'], '#MINUSES_COUNT#' => $arItem['PROPERTIES']['MINUSES_COUNT']['VALUE']]); ?>">
							<?= $arItem['PROPERTIES']['VOTE_RESULT']['VALUE']; ?>
						</span>

                                    <button type="button" class="btn voting-wjt__button ">
                                        <a class="btn voting-wjt__button"
                                           href="<?= $APPLICATION->GetCurPageParam("VOTE=MINUS&ITEM_ID=" . $arItem["ID"], ["VOTE", "ITEM_ID"], false); ?>"
                                           title="<?= GetMessage("VOTE_BUTTON_MINUS_TITLE"); ?>">
